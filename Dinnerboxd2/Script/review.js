...
selectReviews()
    ...
    function showreview(tabIndex) {
        ...
        for (let i = start; i < end; i++) {
            ...
            const reviewContent = `<span class="review-name">${review[i].name}<br></span><span class="stars">${stars}${emptyStars}</span><p class="review-text">${review[i].text}</p><span class="review-date">${review[i].date}</span>`;
